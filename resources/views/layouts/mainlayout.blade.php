...
<head>
    ...
    <!-- PACE-->
    <link rel="stylesheet" type="text/css" href="{{ asset('template/plugins/PACE/themes/blue/pace-theme-flash.css') }}">
    <script type="text/javascript" src="{{ asset('template/plugins/PACE/pace.min.js') }}"></script>
    <!-- Bootstrap CSS-->
    <link rel="stylesheet" type="text/css" href="{{ asset('template/plugins/bootstrap/dist/css/bootstrap.min.css') }}">
    <!-- Fonts-->
    <link rel="stylesheet" type="text/css" href="{{ asset('template/plugins/themify-icons/themify-icons.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('template/plugins/font-awesome/css/font-awesome.min.css') }}">
    <!-- Malihu Scrollbar-->
    <link rel="stylesheet" type="text/css" href="{{ asset('template/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css') }}">
    <!-- Animo.js-->
    <link rel="stylesheet" type="text/css" href="{{ asset('template/plugins/animo.js/animate-animo.min.css') }}">
    <!-- Bootstrap Progressbar-->
    <link rel="stylesheet" type="text/css" href="{{ asset('template/plugins/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css') }}">
    <!-- Summernote-->
    <link rel="stylesheet" type="text/css" href="{{ asset('template/plugins/summernote/dist/summernote.css') }}">
    <!-- Toastr-->
    <link rel="stylesheet" type="text/css" href="{{ asset('template/plugins/toastr/toastr.min.css') }}">
    <!-- SpinKit-->
    <link rel="stylesheet" type="text/css" href="{{ asset('template/plugins/SpinKit/css/spinners/7-three-bounce.css') }}">
    <!-- Jvector Map-->
    <link rel="stylesheet" type="text/css" href="{{ asset('template/plugins/jvectormap/jquery-jvectormap-2.0.3.css') }}">
    <!-- Morris Chart-->
    <link rel="stylesheet" type="text/css" href="{{ asset('template/plugins/morris.js/morris.css') }}">
    <!-- DataTables-->
    <link rel="stylesheet" type="text/css" href="{{ asset('template/plugins/datatables.net-bs/css/dataTables.bootstrap.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('template/plugins/datatables.net-buttons-bs/css/buttons.bootstrap.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('template/plugins/datatables.net-colreorder-bs/css/colReorder.bootstrap.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('template/plugins/datatables.net-responsive-bs/css/responsive.bootstrap.min.css') }}">
    <!-- Weather Icons-->
    <link rel="stylesheet" type="text/css" href="{{ asset('template/plugins/weather-icons/css/weather-icons-wind.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('template/plugins/weather-icons/css/weather-icons.min.css') }}">
    <!-- FullCalendar-->
    <link rel="stylesheet" type="text/css" href="{{ asset('template/plugins/fullcalendar/dist/fullcalendar.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('template/plugins/fullcalendar/dist/fullcalendar.print.css') }}" media="print">
    <!-- jQuery MiniColors-->
    <link rel="stylesheet" type="text/css" href="{{ asset('template/plugins/jquery-minicolors/jquery.minicolors.css') }}">
    <!-- Bootstrap Date Range Picker-->
    <link rel="stylesheet" type="text/css" href="{{ asset('template/plugins/bootstrap-daterangepicker/daterangepicker.css') }}">
    <!-- Primary Style-->
    <link rel="stylesheet" type="text/css" href="{{ asset('template/build/css/umega.css') }}">
    <!-- Skins-->
    <link rel="stylesheet" type="text/css" href="{{ asset('template/build/css/skins.css') }}">
...
<body>
    ...
    <div class="profile">
        <div id="esp-profile" data-percent="65" style="height: 130px; width: 130px; line-height: 100px; padding: 15px;" class="easy-pie-chart"><img src="{{ asset('template/build/images/users/04.jpg') }}" alt="" class="avatar img-circle"><span class="status bg-success"></span><canvas height="162" width="162" style="height: 130px; width: 130px;"></canvas></div>
    ...
    <div class="tab-content nav-sidebar-content">
        <div id="menu" role="tabpanel" class="tab-pane fade in active">
            <ul class="list-unstyled navigation mb-0">
                ...
                <li><a href="{{ route('create-post') }}" class="active bubble"><i class="ti-home"></i> Add New Post</a></li>
            ...
            <ul class="list-unstyled pl-15 pr-15">
                <li class="mb-20">
                    ...
                    <div class="progress progress-xs mb-0">
                        <div role="progressbar" data-transitiongoal="65" class="progress-bar progress-bar-warning" style="width: 65%;" aria-valuenow="65"></div>
                    </div>
                </li>
                <li class="mb-20">
                    ...
                    <div class="progress progress-xs mb-0">
                        <div role="progressbar" data-transitiongoal="80" class="progress-bar progress-bar-danger" style="width: 80%;" aria-valuenow="80"></div>
                    </div>
                </li>
            </ul>
        </div>
...
<!-- jQuery Cookie-->
<script type="text/javascript" src="{{ asset('template/plugins/jquery.cookie/jquery.cookie.js') }}"></script>
...
<script type="text/javascript" src="{{ asset('template/plugins/jquery-advanced-news-ticker/js/newsTicker.js') }}"></script>
<!-- Malihu Scrollbar-->
<script type="text/javascript" src="{{ asset('template/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js') }}"></script>
<!-- Animo.js-->
<script type="text/javascript" src="{{ asset('template/plugins/animo.js/animo.min.js') }}"></script>
<!-- Bootstrap Progressbar-->
<script type="text/javascript" src="{{ asset('template/plugins/bootstrap-progressbar/bootstrap-progressbar.min.js') }}"></script>
<!-- jQuery Easy Pie Chart-->
<script type="text/javascript" src="{{ asset('template/plugins/jquery.easy-pie-chart/dist/jquery.easypiechart.min.js') }}"></script>
<!-- Sparkline-->
<script type="text/javascript" src="{{ asset('template/plugins/kapusta-jquery.sparkline/dist/jquery.sparkline.min.js') }}"></script>
<!-- Summernote-->
<script type="text/javascript" src="{{ asset('template/plugins/summernote/dist/summernote.min.js') }}"></script>
<!-- Toastr-->
<script type="text/javascript" src="{{ asset('template/plugins/toastr/toastr.min.js') }}"></script>
<!-- MomentJS-->
<script type="text/javascript" src="{{ asset('template/plugins/moment/min/moment.min.js') }}"></script>
<!-- jQuery BlockUI-->
<script type="text/javascript" src="{{ asset('template/plugins/blockUI/jquery.blockUI.js') }}"></script>
<!-- jQuery Counter Up-->
<script type="text/javascript" src="{{ asset('template/plugins/jquery-waypoints/waypoints.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('template/plugins/Counter-Up/jquery.counterup.min.js') }}"></script>
<!-- Jvector Map-->
<script type="text/javascript" src="{{ asset('template/plugins/jvectormap/jquery-jvectormap-2.0.3.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('template/plugins/jvectormap/maps/jquery-jvectormap-world-mill.js') }}"></script>
<!-- Flot Charts--><!--[if lte IE 8]>
<script type="text/javascript" src="{{ asset('template/https://raw.githubusercontent.com/flot/flot/master/excanvas.min.js') }}"></script>
<![endif]-->
<script type="text/javascript" src="{{ asset('template/plugins/flot/jquery.flot.js') }}"></script>
<script type="text/javascript" src="{{ asset('template/plugins/flot/jquery.flot.resize.js') }}"></script>
<script type="text/javascript" src="{{ asset('template/plugins/flot.curvedlines/curvedLines.js') }}"></script>
<script type="text/javascript" src="{{ asset('template/plugins/flot.tooltip/js/jquery.flot.tooltip.min.js') }}"></script>
<!-- Morris Chart-->
<script type="text/javascript" src="{{ asset('template/plugins/raphael/raphael-min.js') }}"></script>
<script type="text/javascript" src="{{ asset('template/plugins/morris.js/morris.min.js') }}"></script>
<!-- DataTables-->
...
<script type="text/javascript" src="{{ asset('template/plugins/datatables.net-buttons/js/dataTables.buttons.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('template/plugins/datatables.net-buttons-bs/js/buttons.bootstrap.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('template/plugins/jszip/dist/jszip.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('template/plugins/pdfmake/build/pdfmake.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('template/plugins/pdfmake/build/vfs_fonts.js') }}"></script>
<script type="text/javascript" src="{{ asset('template/plugins/datatables.net-buttons/js/buttons.print.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('template/plugins/datatables.net-buttons/js/buttons.html5.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('template/plugins/datatables.net-colreorder/js/dataTables.colReorder.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('template/plugins/datatables.net-responsive/js/dataTables.responsive.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('template/plugins/datatables.net-responsive-bs/js/responsive.bootstrap.js') }}"></script>
<!-- jQuery UI-->
<script type="text/javascript" src="{{ asset('template/plugins/jquery-ui/jquery-ui.min.js') }}"></script>
<!-- FullCalendar-->
<script type="text/javascript" src="{{ asset('template/plugins/fullcalendar/dist/fullcalendar.min.js') }}"></script>
<!-- jQuery MiniColors-->
<script type="text/javascript" src="{{ asset('template/plugins/jquery-minicolors/jquery.minicolors.min.js') }}"></script>
<!-- Bootstrap Date Range Picker-->
<script type="text/javascript" src="{{ asset('template/plugins/bootstrap-daterangepicker/daterangepicker.js') }}"></script>
<!-- Custom JS-->
<script type="text/javascript" src="{{ asset('template/build/js/app.js') }}"></script>
<script type="text/javascript" src="{{ asset('template/build/js/demo.js') }}"></script>
<script type="text/javascript" src="{{ asset('template/build/js/pages/index.js') }}"></script>
@yield('scripts')
</body>
</html>